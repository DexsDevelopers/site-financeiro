...
<script src="<?= asset('assets/js/tour-lite.js') ?>" defer></script>
<script src="<?= asset('assets/js/onboarding-steps.js') ?>" defer></script>
<script src="<?= asset('assets/js/onboarding.js') ?>" defer></script>
